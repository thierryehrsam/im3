...
{
    $url = "https://api.open-meteo.com/v1/forecast?latitude=$latitude&longitude=$longitude&daily=snowfall_sum,temperature_2m_max,temperature_2m_min,cloud_cover_mean,precipitation_sum&past_days=1&forecast_days=0&ref=freepublicapis.com";
